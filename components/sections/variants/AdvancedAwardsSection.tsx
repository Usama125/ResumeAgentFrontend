      ...
      <div className="space-y-4 sm:space-y-6">
        {hasData ? (
                  ...
                  <div className="mb-3 sm:mb-4">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                      <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#10a37f]/20 to-[#0d8f6f]/20 rounded-xl shadow-lg backdrop-blur-sm">
                        <Trophy className="w-5 h-5 sm:w-6 sm:h-6 text-[#10a37f]" />
                      </div>
                      <div>
                        <h3 className={`text-base sm:text-xl font-bold ${theme.text.primary} group-hover/award:text-[#10a37f] transition-colors mb-1`}>
                          {award.title}
                        </h3>
                        {award.issuer && (
                  ...
                  {award.date && (
                    <div className={`flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl ${
                      ...
                      <div>
                        ...
                        <p className={`font-medium text-sm sm:text-base ${theme.text.primary}`}>{award.date}</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className={`text-center py-8 sm:py-12 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <p className="text-xs sm:text-sm mb-1">Add your achievements and recognitions to showcase your accomplishments.</p>
