      ...
      <div className="relative z-10 p-4 sm:p-8">
        ...
        {hasData ? (
          <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="relative z-10 p-4 sm:p-6">
                        ...
                        {shouldTruncate && (
                          <div className="flex justify-center mt-3">
                            <button
                              ...
                              className={`group flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl transition-all duration-300 ${
                                isDark 
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                      {project.github_url && (
                        ...
                        >
                          <Github className="w-3 h-3 sm:w-4 sm:h-4 group-hover:animate-pulse" />
                      ...
                      {project.url && (
                        ...
                        >
                          <Eye className="w-3 h-3 sm:w-4 sm:h-4 group-hover:animate-pulse" />
                     ...
                     {project.technologies && project.technologies.length > 0 && (
                       <div className="space-y-2 sm:space-y-3">
                         <div className="flex items-center gap-2">
                           ...
                           <span className={`font-semibold text-sm sm:text-base ${theme.text.primary}`}>Skills Used</span>
                         </div>
                             ...
                             return (
                               <>
                                 {technologiesToShow.map((tech, techIndex) => (
                                   <span 
                                     key={techIndex} 
                                     className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-[#10a37f]/20 text-[#10a37f] text-xs sm:text-sm rounded-full border border-[#10a37f]/30 whitespace-nowrap hover:bg-[#10a37f]/30 transition-colors"
                                     title={tech}
                                   >
                                     {tech}
                                   </span>
                                 ...
                                 {hasMoreTechnologies && !isExpanded && (
                                   <>
                                     <span className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-500/20 text-gray-500 text-xs sm:text-sm rounded-full border border-gray-500/30">
                                       +{project.technologies.length - 5}
                                     </span>
                                     <button
                                       onClick={() => toggleTechnologiesExpansion(index)}
                                       className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-blue-500/20 text-blue-500 text-xs sm:text-sm rounded-full border border-blue-500/30 hover:bg-blue-500/30 transition-colors cursor-pointer"
                                     >
                                       See All
                                     </button>
                                   </>
                                 ...
                                 {hasMoreTechnologies && isExpanded && (
                                   <button
                                     onClick={() => toggleTechnologiesExpansion(index)}
                                     className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-orange-500/20 text-orange-500 text-xs sm:text-sm rounded-full border border-orange-500/30 hover:bg-orange-500/30 transition-colors cursor-pointer"
                                   >
                                     See Less
                                   </button>
                                 )}
            ...
            {/* Projects Summary */}
            <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 p-3 sm:p-4 rounded-xl ${
              isDark 
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-br from-[#10a37f]/20 to-[#0d8f6f]/20 backdrop-blur-sm">
                  <Award className="w-3 h-3 sm:w-4 sm:h-4 text-[#10a37f]" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <Globe className="w-3 h-3 sm:w-4 sm:h-4 text-[#10a37f]" />
                  <span className={`text-xs sm:text-sm font-medium ${theme.text.primary}`}>
          ...
          <div className="text-center py-8 sm:py-12">
            <div className="relative mb-4 sm:mb-6">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full bg-gradient-to-br from-[#10a37f]/20 to-[#0d8f6f]/20 flex items-center justify-center backdrop-blur-sm">
                <Award className="w-8 h-8 sm:w-10 sm:h-10 text-[#10a37f]" />
              </div>
