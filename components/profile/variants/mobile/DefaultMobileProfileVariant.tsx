...
const DefaultMobileProfileVariant = memo(function DefaultMobileProfileVariant({
  user,
  isEditMode = false,
  isCurrentUser = false,
  onEditPhoto,
    ...
    <div className={`${isDark ? 'bg-[#212121]' : 'bg-gray-50'} min-h-screen`}>
      ...
      {!(isCurrentUser && !isEditMode && isProfileEmpty(user)) && (
        <div className="relative z-10 p-4">
          ...
          {/* Name & Title - Centered like desktop */}
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              {user.contact_info.email && (
                ...
                >
                  ...
                  <Mail className="relative w-4 h-4 text-[#10a37f] group-hover:text-[#0d8f6f] transition-colors" />
                </a>
              )}
              {user.contact_info.phone && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <Phone className="relative w-4 h-4 text-[#10a37f] group-hover:text-[#0d8f6f] transition-colors" />
                </a>
              )}
              ...
              {user.contact_info.dribbble && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <svg className="relative w-4 h-4 text-[#ea4c89] group-hover:text-[#ea4c89] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {user.contact_info.behance && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <svg className="relative w-4 h-4 text-[#1769ff] group-hover:text-[#1769ff] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {user.contact_info.medium && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <svg className="relative w-4 h-4 text-[#00ab6c] group-hover:text-[#00ab6c] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {user.contact_info.instagram && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <svg className="relative w-4 h-4 text-[#e4405f] group-hover:text-[#e4405f] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {user.contact_info.facebook && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <svg className="relative w-4 h-4 text-[#1877f2] group-hover:text-[#1877f2] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {user.contact_info.youtube && (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <svg className="relative w-4 h-4 text-[#ff0000] group-hover:text-[#ff0000] transition-colors" fill="currentColor" viewBox="0 0 24 24">
...
export default DefaultMobileProfileVariant