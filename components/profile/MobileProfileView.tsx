...
const MobileProfileSection = memo(function MobileProfileSection({
  user,
  isCurrentUser,
  isEditMode,
  isDark,
              ...
              <div className="flex justify-center mt-4">
                <div className="relative group">
                  ...
                  <button
                    ...
                    className={`relative flex items-center gap-2 px-5 py-2 rounded-xl transition-all duration-300 backdrop-blur-sm border ${
                      isDark 
                        ? 'bg-[#2a2a2a]/60 border-[#10a37f]/30 text-white hover:bg-[#2a2a2a]/80 hover:border-[#10a37f]/50' 
                        : 'bg-white/60 border-[#10a37f]/30 text-gray-900 hover:bg-white/80 hover:border-[#10a37f]/50'
                    } shadow-lg hover:shadow-xl transform hover:scale-105`}
                  ...
                  >
                    ...
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-[#10a37f] to-[#0d8f6f] rounded-full blur-sm opacity-60"></div>
                      <Edit className="relative w-3.5 h-3.5 text-[#10a37f]" />
                    </div>
                    <span className="font-semibold text-xs">Edit Basic Info</span>
...
export default function MobileProfileView({
  ...
  // Memoized profile section props
  ...
  return (
    <div className="flex h-[calc(100vh-56px)] relative w-full">
      ...
      <div className={`${
        ...
        <MobileProfileSection {...profileSectionProps} />
      </div>
