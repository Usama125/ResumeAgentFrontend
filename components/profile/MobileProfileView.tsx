                  ...
                  <div className="relative inline-block mt-2">
                    <span className="text-[#10a37f] hover:text-[#0d8f6f] text-sm font-medium transition-colors cursor-pointer group">
                      ...
                      <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-[99999] transform-gpu top-full left-0 mt-2">
                        <div className={`${isDark ? 'bg-[#2a2a2a] border-[#10a37f]/30' : 'bg-white border-gray-200'} border rounded-lg p-4 shadow-2xl max-w-xs w-80`}>
                          ...
                          <div className="flex gap-1">
                            {project.github_url && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-1 px-2 py-1 bg-gray-800 hover:bg-gray-700 text-white text-xs rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-2xl"
                            ...
                            {project.url && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-1 px-2 py-1 bg-[#10a37f] hover:bg-[#0d8f6f] text-white text-xs rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-2xl"
                          ...
                          {project.technologies.length > 2 && (
                            <div className="relative inline-block">
                              <span className="inline-flex items-center px-3 py-1 bg-[#10a37f]/20 text-[#10a37f] text-sm rounded-full border border-[#10a37f]/30 cursor-pointer hover:bg-[#10a37f]/30 transition-colors group whitespace-nowrap">
                                ...
                                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-[99999] transform-gpu top-full left-0 mt-2">
                                  <div className={`${isDark ? 'bg-[#2a2a2a] border-[#10a37f]/30' : 'bg-white border-gray-200'} border rounded-lg p-3 shadow-2xl min-w-[200px] max-w-[280px]`}>
